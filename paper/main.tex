...
for all odd $n \le 10^{12}$ (no counterexample; 55 minutes on eight
consumer cores),
...
minimal $q$), the latter cross-validating the OEIS sequence A002091.
...
$10^{12}$ % TODO: 最终上界
producing both minimal-prime record sequences, one of which
cross-validates A002091 exactly; (ii) exact representation counts $r(n)$
...
(iv) open-source, single-machine code: the $10^{12}$ verification takes
under one hour on a consumer laptop.
...
$\frac{\ell/(\ell-1)}{1-1/(\ell-1)^2} = \frac{\ell-1}{\ell-2}$,
Collecting the product over all $\ell$,
\[
...
\subsection{Results}
No counterexample exists below $10^{12}$: every odd
$7 \le n \le 10^{12}$ admits both decompositions $n=p+2q$ and $n=2p+q$.
The full run took 3314 seconds on eight performance cores of a consumer
laptop (Apple M-series). The minimal doubled prime attains its maximum
$q_{\min} = 3079$ at $n = 853\,036\,242\,229$ (34 record values in
total; Table~1 shows the tail), and the minimal undoubled prime attains
$q_{\min} = 7129$ at $n = 470\,243\,683\,103$ (43 records). The
noncomposite variant of the undoubled-side record sequence reproduces
the OEIS A002091 $b$-file exactly --- all 41 terms with
$9 \le n \le 10^{12}$ --- providing a full independent cross-validation
of both computations. Complete record lists and the $q_{\min}$
distribution histograms are provided in the repository.

\begin{table}[ht]\centering
\caption{Record values of the minimal prime $q$: left, in $n=p+2q$
(34 records below $10^{12}$, tail shown); right, in $n=2p+q$
(43 records, tail shown).}
\begin{tabular}{rr@{\qquad}rr}
\toprule
$n$ & $q_{\min}$ & $n$ & $q_{\min}$ \\
\midrule
766\,707\,661 & 1609 & 64\,190\,408\,687 & 5281 \\
1\,023\,263\,789 & 1931 & 65\,399\,862\,023 & 5821 \\
8\,032\,822\,531 & 2389 & 220\,607\,894\,851 & 5897 \\
92\,635\,306\,249 & 2719 & 248\,391\,483\,203 & 6301 \\
151\,318\,414\,531 & 2791 & 304\,929\,017\,803 & 6329 \\
352\,799\,777\,983 & 2953 & 332\,468\,180\,567 & 6421 \\
646\,341\,033\,061 & 2971 & 470\,243\,683\,103 & 7129 \\
853\,036\,242\,229 & 3079 & & \\
\bottomrule
\end{tabular}
\end{table}
